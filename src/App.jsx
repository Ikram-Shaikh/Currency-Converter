  ...
  return (
    <section className="container">
      <div className="currency-div">
        ...
        <button disabled={isLoading || amount <= 0} onClick={handleSubmit}>{isLoading ? "Convert..." : "Convert"}</button>
        <hr />
        {convertedAmount && (<h2 className="convertedAmount">{amount} {fromCurrency} = {convertedAmount.toFixed(2)} {toCurrency}</h2>)}
